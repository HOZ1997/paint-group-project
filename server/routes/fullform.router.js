...
router.post('/', (req, res) => {
 ...
 const values = [req.body.fullForm.client.client_type_id, //1
  ...
  req.body.fullForm.client.project_address_notes, //12
  req.body.fullForm.projectDetails.project_propertytype_id, //13
  req.body.fullForm.projectDetails.project_buildingtype_id, //14
  req.body.fullForm.projectDetails.isproject_typeinterior,  //15
  req.body.fullForm.projectDetails.isproject_typeexterior, //16
  req.body.fullForm.projectDetails.isproject_typecabinetry, //17
  req.body.fullForm.projectDetails.isproject_typespecialfeature, //18
  req.body.fullForm.projectDetails.project_startdate,  //19
  req.body.fullForm.projectDetails.project_complete_specificdate,  //20
  req.body.fullForm.specialFeature.specialfeatureexterior_id, //21
  req.body.fullForm.specialFeaturespecialfeature_paintproduct, //22
  req.body.fullForm.specialFeature.isspecialfeaturestatus_needprimer, //23
  req.body.fullForm.specialFeature.isspecialfeaturestatus_patchedrepair, //24
  req.body.fullForm.specialFeature.isspecialfeaturestatus_extensivescraping,  //25
